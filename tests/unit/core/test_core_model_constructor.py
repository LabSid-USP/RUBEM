    ...
    def setUp(self):
        ...
        self.configDict = {
            ...
            "DIRECTORIES": {
                ...
                "landuse": self.currentDir + "/fixtures/base/maps/cover/",
            },
            "FILENAME_PREFIXES": {
                "etp_prefix": "etp",
                "prec_prefix": "prec",
            ...
            "TABLES": {
                ...
                "a_i": self.currentDir + "/fixtures/base/txt/cover/a_i.txt",
                "a_o": self.currentDir + "/fixtures/base/txt/cover/a_o.txt",
                "a_s": self.currentDir + "/fixtures/base/txt/cover/a_s.txt",
                "a_v": self.currentDir + "/fixtures/base/txt/cover/a_v.txt",
                "manning": self.currentDir + "/fixtures/base/txt/cover/manning.txt",
                ...
                "k_c_min": self.currentDir + "/fixtures/base/txt/cover/kcmin.txt",
                "k_c_max": self.currentDir + "/fixtures/base/txt/cover/kcmax.txt",
